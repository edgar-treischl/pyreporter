...
This guide walks you through your first report with PyReporter.
...
3. Access to a LimeSurvey instance
...
| `AUDIENCE` | Target audience | `sus` (students), `leh` (teachers), `elt` (parents), `ubb` (UBB), `all` |
| `UBB` | UBB | `True`, `False` |
